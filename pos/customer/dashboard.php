            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="orders_reports.php" class="btn btn-sm btn-dark"><i class="fa-solid fa-eye"></i> See all</a>
                </div>
              </div>
            </div>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="payments_reports.php" class="btn btn-sm btn-dark"><i class="fa-solid fa-eye"></i> See all</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
